...
<div style={{maxWidth:'1200px', margin:'20px 20px -50px 10px', display:'flex', justifyContent:'space-between', alignItems:'center'}}>
...
<section style={{
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
    ...
    {[
	  ...
	  {
        questionFR: "Comment obtenir mon premier Avis Google par SMS",
        answerFR: "Compléter l'Étape 1 un peu plus haut sur cette page, ce sera ce message qui sera envoyé à votre client. Par exemple: Bonjour {client_name}! Suite à votre visite chez {business_name} nous aimerions avoir votre avis... + le lien de votre URL Avis Google ou de votre site web si vous envoyer un SMS Marketing. ATTENTION: Il faudra concerver ceci: {client_name} et {business_name} afin de personaliser votre message. Si vous envoyer que des messages en français, vous pouvez remplir que la partie Message en français et faire Sauvegarder afin d'enregistrer votre message. Ensuite à l'Étape 2, vous remplissez Prénom et # de tél et cliquer sur le bouton envoyer pour envoyer votre message dans la langue de votre choix.",
        questionEN: "How to get my first Google review via SMS",
        answerEN: "Complete Step 1 above on this page. This section will be the message that will be sent to your client. For example: Hello {client_name}! Following your visit to {business_name}, we would like to have your feedback... + the link to your Google review URL or your website if you are sending an SMS marketing message. IMPORTANT: You will need to keep {client_name} and {business_name} to personalize your message. If you are only sending messages in French, you can fill in only the French Message section and click Save to save your message. Then, in Step 2, fill in First Name and Phone Number and click the Send button to send your message in the language of your choice."
      },
      {
        questionFR: "Comment trouver mon lien pour les Avis Google ?",
        answerFR: "1️⃣ Allez sur votre fiche Google Business. 2️⃣ Cliquez sur “Demander des avis”. 3️⃣ Copiez le lien généré par Google. 4️⃣ Collez ce lien dans votre message SMS dans Starsloo. Vos clients pourront alors laisser un avis en un seul clic ⭐ Astuce - Vous pouvez aussi trouver ce lien en recherchant votre entreprise sur Google. Dans votre fiche entreprise, cliquez sur “Demander des avis” puis copiez le lien.",
        questionEN: "How do I find my link for Google Reviews?",
        answerEN: "1️⃣ Go to your Google Business Profile. 2️⃣ Click on “Request reviews”. 3️⃣ Copy the link generated by Google. 4️⃣ Paste this link into your SMS message in Starsloo. Your customers will then be able to leave a review with a single click. ⭐ Tip - You can also find this link by searching for your business on Google. In your business profile, click on “Request reviews” and then copy the link." 
      },
	  {
      ...
      {
        questionFR: "Que se passe-t-il si je dépasse ma limite de SMS ?",
        answerFR: "Si votre limite mensuelle est atteinte, il vous sera possible d'acheter un bloc de SMS supplémentaire ou encore passer au plan supérieur pour continuer vos envois.",
        questionEN: "What happens if I exceed my SMS limit?",
        answerEN: "If you reach your monthly limit, you can purchase an additional SMS block or upgrade to a higher plan to continue sending messages."
      },
	  {
        questionFR: "Parcequ'on est une équipe extraordinaire, voici quelques messages déjà fait pour vous",
        answerFR: "Bonjour {client_name}! Merci pour votre visite chez {business_name}. Votre avis compte énormément pour nous 🙏 Vous pouvez nous laisser un commentaire ici : [LIEN_AVIS_GOOGLE] - Bonjour {client_name}, suite à votre passage chez {business_name}, nous aimerions connaître votre expérience. Cela ne prend qu’une minute : [LIEN_AVIS_GOOGLE] - Merci d’avoir choisi {business_name}, {client_name}! Si vous avez apprécié votre visite, un petit avis nous aiderait beaucoup 😊 [LIEN_AVIS_GOOGLE] - Salut {client_name}! On espère que vous avez adoré votre expérience chez {business_name} 🤍 Un petit avis ici nous ferait vraiment plaisir : [LIEN_AVIS_GOOGLE]",
        questionEN: "Because we're an extraordinary team, here are some messages already written for you.",
        answerEN: "Hello {client_name}! Thank you for visiting {business_name}. Your opinion means a lot to us 🙏 You can leave us a review here: [GOOGLE_REVIEW_LINK] - Hello {client_name}, following your visit to {business_name}, we would like to know about your experience. It only takes a minute: [GOOGLE_REVIEW_LINK] - Thank you for choosing {business_name}, {client_name}! If you enjoyed your visit, a short review would help us a lot 😊 [GOOGLE_REVIEW_LINK] - Hi {client_name}! We hope you loved your experience at {business_name} 🤍 A short review here would really make us happy: [GOOGLE_REVIEW_LINK] - Hello {client_name}! The entire {business_name} team thanks you 🙌 If you have 30 seconds, here's the link to leave us your review: [GOOGLE_REVIEW_LINK]"
      }
    ].map((faq, index) => (
      <div key={index} style={{
        background: '#ffffff',
